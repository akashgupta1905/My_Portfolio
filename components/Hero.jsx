      ...
      <div className="hero-content-container">
        <div className="max-md:order-2 flex flex-col gap-5 z-40">
          <div className="text-4xl lg:text-6xl">
            <h1>Hi, I'm Akash a</h1>
            <span className="font-bold text-dark-red">Developer</span>
            <h2>From India</h2>
            <p className="mt-5 text-xl">
            Aspiring IT Professional | MERN Developer | Problem Solver 
            </p>
          </div>
        ...
        <Image src="/assets/hero.png" width={450} height={450} alt="Antonio Rogers" className="z-10" />
      </div>
